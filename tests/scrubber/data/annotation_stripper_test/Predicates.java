 ...
 */
// Makes type parameters, eg <T>, nullable by default.
...
public final class Predicates {
  ...
  public static <T> Predicate<T> equalTo(@Nullable T target) {
    ...
    return (target == null)
        ? Predicates.<T>isNull()
        : new IsEqualToPredicate</*@NonNull*/ T>(target);
  }
  ...
  public static Predicate</*@Nullable*/ Object> instanceOf(Class<?> clazz) {
   ...
   */
  // TODO(piotrzielinski): investigate how to make T @Nullable here.
  // This is not trivial because Collection<T>.contains() takes an
  // Object, not T.  Since some collections do not support null,
  // changing that to @Nullable Object is risky.
  public static </*@NonNull*/ T>
      Predicate<T> in(Collection<? extends T> target) {
  ...
  enum AlwaysTruePredicate implements Predicate</*@Nullable*/ Object> {
    INSTANCE;
  ...
  // Package private for GWT serialization.
  enum AlwaysFalsePredicate implements Predicate</*@Nullable*/ Object> {
    INSTANCE;
  ...
  private static class IsEqualToPredicate</*@NonNull*/ T>
  ...
  private enum IsNullPredicate implements Predicate</*@Nullable*/ Object> {
    INSTANCE;
  ...
  // enum singleton pattern
  private enum NotNullPredicate implements Predicate</*@Nullable*/ Object> {
    INSTANCE;
  ...
  private static class InPredicate</*@NonNull*/ T>
      implements Predicate<T>, Serializable {
